...
function appendList(categories) {
    ...
    categories.forEach(category => {
        ...
        scrollItem.onclick = () => {
            ...
            var parameters = { 'event': category.name.replace(/<br\s*\/?>/gi, '').replace(/\s+/g, ' ').trim() };
